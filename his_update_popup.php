...
?>
<form name='update_payment' method='post' action="update_payment.php" enctype="multipart/form-data">
	<table width="100%" id="update_payment">
		<tr>
			<td width="30%">
				<label for="date">Payment Date</label>
			</td>
			<td width="70%">
				<input class="form-control" type="text" size="12" name="date" id="dateField" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<p><b>$</b><input id="amout_input_payment" class="form-control" type="text" name="amount" maxlength="50" size="9"></p>
			</td>
		</tr>

		<tr>
			<td colspan="2">
				<input type="submit" value="Submit" class="btn btn-success btn-sm">&nbsp; <input type="reset" value="Reset" class="btn btn-default btn-sm">
