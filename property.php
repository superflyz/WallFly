    ...
    <div class="container-fluid2" id="content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          ?>
          <div>
            <button class="add_btn" onclick="javascript:void window.open('add_popup.php','1428456850982','width=700,height=500,toolbar=0,menubar=0,location=0,status=0,scrollbars=1,resizable=1,left=0,top=0');return false;"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Add Property</button>
          </div>
          <?php
          }
          ?>
          <br>
          <div>
            <button id="calendar_btn"><span class="glyphicon glyphicon-calendar"></span>&nbsp;&nbsp;Calendar</button>
          </div>
        </div>
      </div>
